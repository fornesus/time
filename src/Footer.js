...
class Footer extends React.Component {
  ...
  render(){
    return <span><a href="https://chrisfornesa.com" target="_blank" rel="noopener noreferrer">Chris Fornesa</a> &copy; {this.state.year} | <a href="https://php.time.chrisfornesa.com">PHP</a></span>;
  }
}
